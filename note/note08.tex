...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[scale=.9,page=4]{fig/bjork.pdf}
...
\begin{frame}
  \begin{figure}[!htbp]
    \centering
    \includegraphics[scale=1,page=5]{fig/bjork.pdf}
...
%  \begin{figure}[!htbp]
%    \centering
%    \includegraphics[scale=1,page=6]{fig/bjork.pdf}
%    \caption{Payoff at the End of Terms.}
%  \end{figure}
%\end{frame}
...
\begin{frame}
  \begin{figure}[!htbp]
    \centering
    \includegraphics[scale=1,page=7]{fig/bjork.pdf}
...
%  \begin{figure}[!htbp]
%    \centering
%    \includegraphics[scale=1,page=8]{fig/bjork.pdf}
%    \caption{Payoff at the End of Terms.}
%  \end{figure}
%\end{frame}
...
\begin{frame}
  \begin{figure}[!htbp]
    \centering
    \includegraphics[scale=1,page=9]{fig/bjork.pdf}
...
\begin{frame}
  \begin{figure}[!htbp]
    \centering
    \includegraphics[scale=1.05,page=10]{fig/bjork.pdf}
    \caption{Replicating $h_t=(x_t, y_t):\;$ $\ds x = \frac{1}{1+R}\,\frac{u\Phi(d)-d\,\Phi(u)}{u-d}$, $y$ $=$ $\ds\frac{1}{s}\,\frac{\Phi(u)-\Phi(d)}{u-d}$}
  \end{figure}
\end{frame}
