...
\begin{frame}
  \begin{figure}[!htbp]
    \centering
    \includegraphics[scale=1.1,page=1]{fig/note07/sfm.pdf}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[scale=1.1,page=2]{fig/note07/sfm.pdf}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[scale=1,page=3]{fig/note07/sfm.pdf}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[scale=1.1,page=4]{fig/note07/sfm.pdf}
