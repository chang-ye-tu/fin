...
\begin{frame}{Data Morph}
  \begin{center}
  \animategraphics[autoplay,loop,width=0.49\textwidth]{4}{fig/note01/dog_to_rings/frame-}{0}{198}
  \animategraphics[autoplay,loop,width=0.49\textwidth]{4}{fig/note01/dog_to_star/frame-}{0}{198}
  \animategraphics[autoplay,loop,width=0.49\textwidth]{4}{fig/note01/dog_to_v_lines/frame-}{0}{198}
  \animategraphics[autoplay,loop,width=0.49\textwidth]{4}{fig/note01/dog_to_h_lines/frame-}{0}{198}
